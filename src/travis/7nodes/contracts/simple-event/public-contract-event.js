...
console.log('getting abit')
console.log(contractjson.contracts)
var abi = contractjson.contracts['src/SimpleEvent.sol:SimpleStoreEvent'].abi
console.log('parse abi')
var contract = eth.contract(JSON.parse(abi))
console.log('get bin ')
var bin = "0x" + contractjson.contracts['src/SimpleEvent.sol:SimpleStoreEvent'].bin

personal.unlockAccount(eth.accounts[0])

var deployTransationObject = {from: eth.accounts[0], data: bin, gas: 1000000};
var instance = contract.new(deployTransationObject, function (e, contract) {
    if (e) {
...
//var productCatAddress = eth.getTransactionReceipt(productInstance.transactionHash).contractAddress
//productCatAddress
//console.log("Contract mined! Address: " + productCatAddress);
//var pc=productCatContract.at(productCatAddress);

//pc.createProduct.sendTransaction(libby, 12, {from: eth.accounts[0], gas: 1000000})

//pc.getProductCount.call()
