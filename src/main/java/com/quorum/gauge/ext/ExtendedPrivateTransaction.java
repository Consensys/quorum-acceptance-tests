...
/**
 * Same as {@link org.web3j.quorum.methods.request.PrivateTransaction} but adding support for gasprice param
 *
 * @see org.web3j.quorum.methods.request.PrivateTransaction
 */
public class ExtendedPrivateTransaction extends Transaction {

    private String privateFrom;
    private List<String> privateFor;

    public ExtendedPrivateTransaction(
