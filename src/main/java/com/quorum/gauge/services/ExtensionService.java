...
public class ExtensionService extends AbstractService {
    ...
    public Observable<QuorumVoteOnContract> acceptExtension(QuorumNetworkProperty.Node node, boolean vote, String address, List<String> privateFor, PrivacyFlag privacyFlag) {
    ...
    public Observable<QuorumVoteOnContract> acceptExtension(final QuorumNetworkProperty.Node node,
        ...
        final List<String> privateFor = allNodes
            ...
            .collect(Collectors.toList());
        return acceptExtension(node, vote, address, privateFor, privacyFlag);
    }
