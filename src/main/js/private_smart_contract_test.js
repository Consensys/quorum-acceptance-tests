...
async function testContract(privateFlag, fromNodeId, toNodeId, eventCnt) {
...
//create the contract
    ...
    await TestContract.deploy({
        ...
        logger.debug("private fromNode:" + fromNodeId + " toNode:"+ toNodeId +" eventCnt:" + eventCnt)
...
step('private smart contract from node <fromNodeNo> to node <toNodeNo> with <eventCnt> events',
    ...
    var res = await testContract(true, fromNodeNo, toNodeNo, eventCnt)
