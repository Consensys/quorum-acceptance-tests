...
async function testContract(privateFlag, nodeId, eventCnt) {
...
//create the contract
    ...
    await TestContract.deploy({
        ...
        logger.debug("public nodeNo:" + nodeId + " eventCnt:"+ txCnt)
    ...
    return true
        ...
        step('public smart contract from node <nodeNo> with <eventCnt> events', async function (nodeNo, eventCnt) {
            var res = await testContract(false, nodeNo, eventCnt)
