...
* Verify the stored data "contratctsData1" into the store to have the right value
* Verify the stored data "contratctsData2" into the store to have the right value
* Verify the stored data "contratctsData3" into the store to have the right value
