...
* Deploy a "StateValidation" C1 contract with initial value "42" in "Node2"'s default account and it's private for "Node4", named this contract as "contract1Extension"
* "contract1Extension" is deployed "successfully" in "Node2,Node4"
* Fail to execute "StateValidation" simple contract("contract1Extension")'s `set()` function with new arbitrary value in "Node1" and it's private for "Node2,Node4"
...
* Create a "StateValidation" extension to "Node1" from "Node2" with "Node2,Node4" as voters for contract "contract1Extension"
...
* Fire and forget execution of "StateValidation" simple contract("contract1Extension")'s `set()` function with value "86" in "Node1" and it's private for "Node2,Node4"
* "contract1Extension"'s `get()` function execution in "Node4" returns "86"
* "contract1Extension"'s `get()` function execution in "Node2" returns "86"
* "contract1Extension"'s `get()` function execution in "Node1" returns "86"

## Extend contract but new party doesn't accept

* Deploy a "StateValidation" C1 contract with initial value "42" in "Node2"'s default account and it's private for "Node4", named this contract as "contract2Extension"
* "contract2Extension" is deployed "successfully" in "Node2,Node4"
* Fail to execute "StateValidation" simple contract("contract2Extension")'s `set()` function with new arbitrary value in "Node1" and it's private for "Node2,Node4"
...
* Create a "StateValidation" extension to "Node1" from "Node2" with "Node2,Node4" as voters for contract "contract2Extension"
...
* Deploy a "StateValidation" C1 contract with initial value "42" in "Node2"'s default account and it's private for "Node4", named this contract as "contract3Extension"
* "contract3Extension" is deployed "successfully" in "Node2,Node4"
* Fail to execute "StateValidation" simple contract("contract3Extension")'s `set()` function with new arbitrary value in "Node1" and it's private for "Node2,Node4"
...
* Create a "StateValidation" extension to "Node1" from "Node2" with "Node2,Node4" as voters for contract "contract3Extension"
...
* Deploy a "StateValidation" C1 contract with initial value "42" in "Node2"'s default account and it's private for "Node4", named this contract as "contract4Extension"
* "contract4Extension" is deployed "successfully" in "Node2,Node4"

* Create a "StateValidation" extension to "Node1" from "Node2" with "Node2,Node4" as voters for contract "contract4Extension"
