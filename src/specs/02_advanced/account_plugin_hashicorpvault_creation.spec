# Pluggable Architecture with Hashicorp Vault implementation of account plugin
 ...
 Tags: networks/plugins::raft-account-plugin-hashicorp-vault, networks/plugins::qbft-account-plugin-hashicorp-vault, plugin-account, hashicorp-vault, account-creation
