# QBFT consensus - Validator and non-validator behaviour
  ...
  Tags: networks/template::qbft-3plus1, pre-condition/no-record-blocknumber, validator-management

This specification describes how validator and non-validator nodes behave in qbft
