# Block synchronization in permissioned network with archive gcmode using Raft consensus

 Tags: advanced-1.18.12, permissioned, gcmode, archive, sync, raft
...
* Start a "permissioned" Quorum Network, named it "alpha", with "3" nodes with "archive" `gcmode`s using "raft" consensus
