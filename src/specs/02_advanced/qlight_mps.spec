...
## A QLight client can only access only the configured private state from the QLight server node
...
* Transaction Receipt is present in "Node5" for "accPublic1" from "Node1"'s default account
* Transaction Receipt is present in "Node6" for "accPublic1" from "Node1"'s default account
* Transaction Receipt is present in "Node7" for "accPublic1" from "Node1"'s default account
* Subscribe to accumulator contract "accPublic1" IncEvent on "Node1,Node2,Node3,Node4,Node5,Node6,Node7"
...
* Accumulator "accPublic1"'s `get()` function execution in "Node5" returns "1"
* Accumulator "accPublic1"'s `get()` function execution in "Node6" returns "1"
* Accumulator "accPublic1"'s `get()` function execution in "Node7" returns "1"
...
* Transaction Receipt is present in "Node5" for "accPublic1.inc(1)"
* Transaction Receipt is present in "Node6" for "accPublic1.inc(1)"
* Transaction Receipt is present in "Node7" for "accPublic1.inc(1)"
...
* Accumulator "accPublic1"'s `get()` function execution in "Node5" returns "2"
* Accumulator "accPublic1"'s `get()` function execution in "Node6" returns "2"
* Accumulator "accPublic1"'s `get()` function execution in "Node7" returns "2"
...
* Check IncEvent "0" for accumulator contract "accPublic1" on "Node5" has value "2"
* Check IncEvent "0" for accumulator contract "accPublic1" on "Node6" has value "2"
* Check IncEvent "0" for accumulator contract "accPublic1" on "Node7" has value "2"
* Unsubscribe to accumulator contract "accPublic1" IncEvent on "Node1,Node2,Node3,Node4,Node5,Node6,Node7"
...
* Transaction Receipt is present in "Node5" for "accPrivate1" from "Node4"'s default account
* Transaction Receipt is present in "Node6" for "accPrivate1" from "Node4"'s default account
* Transaction Receipt is present in "Node7" for "accPrivate1" from "Node4"'s default account
...
* Accumulator "accPrivate1"'s `get()` function execution in "Node5" returns "1"
* Accumulator "accPrivate1"'s `get()` function execution in "Node6" returns "0"
* Accumulator "accPrivate1"'s `get()` function execution in "Node7" returns "0"
* Subscribe to accumulator contract "accPrivate1" IncEvent on "Node1,Node2,Node3,Node4,Node5,Node6,Node7"
...
* Transaction Receipt is present in "Node5" for "accPrivate1.inc(1)"
* Transaction Receipt in "Node5" for "accPrivate1.inc(1)" has one IncEvent log with value "2"
* Transaction Receipt is present in "Node6" for "accPrivate1.inc(1)"
* Transaction Receipt in "Node6" for "accPrivate1.inc(1)" has no logs
* Transaction Receipt in "Node7" for "accPrivate1.inc(1)" has no logs
...
* Accumulator "accPrivate1"'s `get()` function execution in "Node5" returns "2"
* Accumulator "accPrivate1"'s `get()` function execution in "Node6" returns "0"
* Accumulator "accPrivate1"'s `get()` function execution in "Node7" returns "0"
...
* Check IncEvent list size for accumulator contract "accPrivate1" on "Node5" is "1"
* Check IncEvent "0" for accumulator contract "accPrivate1" on "Node5" has value "2"
* Check IncEvent list size for accumulator contract "accPrivate1" on "Node6" is "0"
* Check IncEvent list size for accumulator contract "accPrivate1" on "Node7" is "0"
...
* Transaction Receipt is present in "Node5" for "accPrivate1.inc(2)"
* Transaction Receipt in "Node5" for "accPrivate1.inc(2)" has one IncEvent log with value "4"
* Transaction Receipt is present in "Node6" for "accPrivate1.inc(2)"
* Transaction Receipt in "Node6" for "accPrivate1.inc(2)" has no logs
* Transaction Receipt is present in "Node7" for "accPrivate1.inc(2)"
* Transaction Receipt in "Node7" for "accPrivate1.inc(2)" has no logs
...
* Accumulator "accPrivate1"'s `get()` function execution in "Node5" returns "4"
* Accumulator "accPrivate1"'s `get()` function execution in "Node6" returns "0"
* Accumulator "accPrivate1"'s `get()` function execution in "Node7" returns "0"
...
* Check IncEvent list size for accumulator contract "accPrivate1" on "Node5" is "2"
* Check IncEvent "1" for accumulator contract "accPrivate1" on "Node5" has value "4"
* Check IncEvent list size for accumulator contract "accPrivate1" on "Node6" is "0"
* Check IncEvent list size for accumulator contract "accPrivate1" on "Node6" is "0"

* Unsubscribe to accumulator contract "accPrivate1" IncEvent on "Node1,Node2,Node3,Node4,Node5,Node6,Node7"


// Deploy a party protection private contract from Node3 to Node7 (second private state on Node1)
* Deploy a "PartyProtection" accumulator contract in "Node3"'s default account with initial value "2" and it's private for "Node7", name this contract as "accPrivate2"
...
* Transaction Receipt is present in "Node5" for "accPrivate2" from "Node3"'s default account
* Transaction Receipt is present in "Node6" for "accPrivate2" from "Node3"'s default account
* Transaction Receipt is present in "Node7" for "accPrivate2" from "Node3"'s default account
* Accumulator "accPrivate2"'s `get()` function execution in "Node1" returns "0"
* Accumulator "accPrivate2"'s `get()` function execution in "Node2" returns "0"
...
* Accumulator "accPrivate2"'s `get()` function execution in "Node5" returns "0"
* Accumulator "accPrivate2"'s `get()` function execution in "Node6" returns "2"
* Accumulator "accPrivate2"'s `get()` function execution in "Node7" returns "2"
* Subscribe to accumulator contract "accPrivate2" IncEvent on "Node1,Node2,Node3,Node4,Node5,Node6,Node7"
* Invoke a "PartyProtection" accumulator.inc with value "5" in contract "accPrivate2" in "Node3"'s default account and it's private for "Node7", file transaction hash as "accPrivate2.inc(5)"
...
* Transaction Receipt in "Node2" for "accPrivate2.inc(5)" has no logs
...
* Transaction Receipt is present in "Node5" for "accPrivate2.inc(5)"
* Transaction Receipt in "Node5" for "accPrivate2.inc(5)" has no logs
* Transaction Receipt is present in "Node6" for "accPrivate2.inc(5)"
* Transaction Receipt in "Node6" for "accPrivate2.inc(5)" has one IncEvent log with value "7"
* Transaction Receipt is present in "Node7" for "accPrivate2.inc(5)"
* Transaction Receipt in "Node7" for "accPrivate2.inc(5)" has one IncEvent log with value "7"
* Accumulator "accPrivate2"'s `get()` function execution in "Node1" returns "0"
* Accumulator "accPrivate2"'s `get()` function execution in "Node2" returns "0"
* Accumulator "accPrivate2"'s `get()` function execution in "Node3" returns "7"
* Accumulator "accPrivate2"'s `get()` function execution in "Node4" returns "0"
* Accumulator "accPrivate2"'s `get()` function execution in "Node5" returns "0"
* Accumulator "accPrivate2"'s `get()` function execution in "Node6" returns "7"
* Accumulator "accPrivate2"'s `get()` function execution in "Node7" returns "7"

* Wait for events poll
* Check IncEvent list size for accumulator contract "accPrivate2" on "Node1" is "0"
* Check IncEvent list size for accumulator contract "accPrivate2" on "Node2" is "0"
...
* Check IncEvent list size for accumulator contract "accPrivate2" on "Node5" is "0"
* Check IncEvent list size for accumulator contract "accPrivate2" on "Node6" is "1"
* Check IncEvent "0" for accumulator contract "accPrivate2" on "Node6" has value "7"
* Check IncEvent list size for accumulator contract "accPrivate2" on "Node7" is "1"
* Check IncEvent "0" for accumulator contract "accPrivate2" on "Node7" has value "7"


* Unsubscribe to accumulator contract "accPrivate2" IncEvent on "Node1,Node2,Node3,Node4,Node5,Node6,Node7"


// trying to invoke as PartyProtection from non party (fails on Node1 private state - as Node1 is not party to accPrivate2)
* Invoking a "PartyProtection" accumulator.inc with value "6" in contract "accPrivate2" in "Node1"'s default account and it's private for "Node7" fails with error "contract not found. cannot transact"
// trying to invoke as PSV (fails on Node7 private state and the privacy flag is different from the accPrivate2 contract privacy flag - PartyProtection)
* Invoking a "StateValidation" accumulator.inc with value "6" in contract "accPrivate2" in "Node7"'s default account and it's private for "Node3" fails with error "sent privacy flag doesn't match all affected contract flags"
// trying to invoke from non party as standard private from Node1 private state
* Invoke a "StandardPrivate" accumulator.inc with value "6" in contract "accPrivate2" in "Node1"'s default account and it's private for "Node7", file transaction hash as "accPrivate2.inc(6)"
* Transaction Receipt in "Node1" for "accPrivate2.inc(6)" has status "0x1"
* Transaction Receipt in "Node7" for "accPrivate2.inc(6)" has status "0x0"
* Accumulator "accPrivate2"'s `get()` function execution in "Node1" returns "0"
* Accumulator "accPrivate2"'s `get()` function execution in "Node2" returns "0"
* Accumulator "accPrivate2"'s `get()` function execution in "Node3" returns "7"
* Accumulator "accPrivate2"'s `get()` function execution in "Node4" returns "0"
...
* Invoke a "StandardPrivate" accumulator.inc with value "7" in contract "accPrivate2" in "Node4"'s default account and it's private for "Node7", file transaction hash as "accPrivate2.inc(7)"
* Transaction Receipt in "Node4" for "accPrivate2.inc(7)" has status "0x1"
* Transaction Receipt in "Node7" for "accPrivate2.inc(7)" has status "0x0"
* Accumulator "accPrivate2"'s `get()` function execution in "Node1" returns "0"
* Accumulator "accPrivate2"'s `get()` function execution in "Node2" returns "0"
* Accumulator "accPrivate2"'s `get()` function execution in "Node3" returns "7"
* Accumulator "accPrivate2"'s `get()` function execution in "Node4" returns "0"
...
* Transaction Receipt is present in "Node5" for "smPrivate1" from "Node1"'s default account
...
* "ssPrivate1"'s `get()` function execution in "Node5" returns "10"
* "ssPrivate1"'s `get()` function execution in "Node6" returns "0"
* "ssPrivate1"'s `get()` function execution in "Node7" returns "0"
...
* "smPrivate2"'s `getC2C3Value()` function execution in "Node5" returns "0"
* "smPrivate2"'s `getC2C3Value()` function execution in "Node6" returns "10"
* "smPrivate2"'s `getC2C3Value()` function execution in "Node7" returns "10"
* Invoke a "StateValidation" setC2C3Value with value "15" in master storage contract "smPrivate2" in "Node7"'s default account and it's private for "Node3"
* "smPrivate2"'s `getC2C3Value()` function execution in "Node1" returns "0"
* "smPrivate2"'s `getC2C3Value()` function execution in "Node2" returns "0"
* "smPrivate2"'s `getC2C3Value()` function execution in "Node3" returns "30"
* "smPrivate2"'s `getC2C3Value()` function execution in "Node4" returns "0"
* "smPrivate2"'s `getC2C3Value()` function execution in "Node5" returns "0"
* "smPrivate2"'s `getC2C3Value()` function execution in "Node6" returns "30"
* "smPrivate2"'s `getC2C3Value()` function execution in "Node7" returns "30"
...
* Retrieve private state root on "Node5" for "blockNumberAfterStateChanges" and name it "Node5_PSR1"
* Retrieve private state root on "Node6" for "blockNumberAfterStateChanges" and name it "Node6_PSR1"
* Retrieve private state root on "Node7" for "blockNumberAfterStateChanges" and name it "Node7_PSR1"
* Check that private state root "Node1_PSR1" is equal to "Node4_PSR1"
* Check that private state root "Node1_PSR1" is equal to "Node5_PSR1"
* Check that private state root "Node7_PSR1" is equal to "Node3_PSR1"
* Check that private state root "Node7_PSR1" is equal to "Node6_PSR1"
* Check that private state root "Node1_PSR1" is different from "Node7_PSR1"
...
* Check on "Node5" that account "0x000000000000000000000000000000000000007a" does not exist at "blockNumberAfterStateChanges"
* Check on "Node6" that account "0x000000000000000000000000000000000000007a" does not exist at "blockNumberAfterStateChanges"
* Check on "Node7" that account "0x000000000000000000000000000000000000007a" does not exist at "blockNumberAfterStateChanges"
