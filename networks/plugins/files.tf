...
SPRING_PROFILES_ACTIVE = ${var.network_name}%{if var.remote_docker_config != null~},proxy%{endif}%{if local.withHashicorpPlugin~},${local.hashicorp_vault_plugin_spring_profile}%{endif}
